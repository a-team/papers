...
\begin{slide}{Tests}
  \begin{itemize}
  \item Tests were written at the same time with the implementation\ldots
    \fromSlide{2}{%
      \begin{itemize}
      \item as a quicker workspace
      \item to run examples quickly
      \fromSlide{3}{%
      \item but not to test user stories}
    \end{itemize}}
  \end{itemize}
\end{slide}}
...
\begin{slide}{Problems with testing}
  ...
  \end{itemize}
  \fromSlide{3}{%
    \raggedleft{\includegraphics[width=0.8\linewidth]{pics/bad_tests}}
  }
\end{slide}}
...
\begin{slide}{Conclusions}
  \begin{itemize}
  \item We're doing quite well estimating overall time
    \begin{itemize}
    \item The past two sprints we managed to implement almost all
      stories
    \item Our estimation total is pretty good
    \end{itemize}
